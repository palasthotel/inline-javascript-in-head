...
/**
 * Define JavaScript handles to be echoed inline in the html head section via `Inline JavaScript` plugin.
 */
...
3. Use the `inline_javascript_handles` filter in your theme or plugin.
4. You’re done!
